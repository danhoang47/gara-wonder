    ...
    return (
        <div className="w-full border-b-1 pt-5 pb-[7.5rem]">
            ...
            <div className="flex gap-4 pt-10">
                <div
                    className="max-w-[15rem] h-32 p-5 flex justify-center items-center shadow-md hover:shadow-2xl rounded-lg border-1 border-default-100 cursor-pointer transition-shadow"
                ...
                >
                    <div>
                        ...
                        <p className="text-lg pt-3">Cài đặt chế độ nhận đơn</p>
                    </div>
                </div>
                <div
                    className="max-w-[15rem] h-32 p-5 flex justify-center items-center shadow-md hover:shadow-2xl rounded-lg border-1 border-default-100 cursor-pointer transition-shadow"
